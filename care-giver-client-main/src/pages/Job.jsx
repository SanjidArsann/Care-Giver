...
const Job = () => {
  ...
  const {
    ...
    queryKey: ["job"],
    queryFn: () => getSingleHandler(`http://localhost:9000/api/v1/jobs/${id}`),
  });
      ...
      <Wrapper>
        <div className="top-row">
          ...
          <h4 className="company">
            <span className="fancy">Patient Name: </span>
            {job?.company}
          </h4>
        ...
        <div className="middle-row">
          ...
          <h4 className="deadline">
            Duration to: <span className="">{date}</span>
          </h4>
          <h4 className="vacancy">
            Job Vacancy: <span className="">{job?.jobVacancy}</span>
          </h4>
          <div className="requirement">
            <h3 className="sec-title">Nursing proficiencies</h3>
            <ul>
          ...
          <h4 className="salary">
            Salary: <span className="">{job?.jobSalary} TK/Day</span>
          </h4>
          <div className="apply">
          ...
          <div className="apply">
            <h3 className="sec-title">Attachments</h3>
            <p className="intro">Download the attachments</p>
            <p className="info">Link: {job?.attachment}</p>
            <img src={job?.attachment} alt="" />
          </div>
        </div>
      </Wrapper>
    </>
