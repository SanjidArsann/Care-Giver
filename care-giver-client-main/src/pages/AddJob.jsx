...
const AddJob = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    const result = await axios.post(
      "http://localhost:9000/api/v1/uploads/files",
      formData,
      {
        withCredentials: true,
      }
    ...
    setAttachment(result?.data?.data?.fileUrl);
  };
        ...
        <div className="content-row">
          <form autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
            <div className="form">
              {/* Position */}
              <div className="row">
                <label htmlFor="position">Patient Disease</label>
                <input
                  type="text"
                  id="position"
                  name="position"
                  ...
                  {...register("position", {
                    required: {
                      value: true,
                      message: "Patient Disease is required",
                    },
                    maxLength: {
                      value: 100,
            ...
            <div className="flex flex-col  min-[600px]:flex-row  justify-between items-center gap-4 mt-5">
              <div className="row gap-y-2">
                <label htmlFor="position">Nursing proficiencies</label>
                <TagsInput
                  value={skills}
                  onChange={setSkills}
                  name="skills"
                  placeHolder="Catheter Management, Medication, Pain Management"
                  separators={["Enter", ","]}
                  onRemoved={["Backspace"]}
                  classNames={{
                    tag: "tag-cls",
            ...
            <div className="row">
              <label htmlFor="attachment">Upload Resume</label>
              <input
